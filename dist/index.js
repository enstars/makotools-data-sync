...
const packageJson = __webpack_require__(852)
...
const getSheet_1 = __importDefault(__webpack_require__(347));
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            for (let i = 0; i < sheetIDs.length; i++) {
                ...
                const data = yield getSheet_1.default(sheetID);
                sheetsData = [...sheetsData, ...data];
            }
            sheetsData = sheetsData.filter((s) => s.name.split("/")[0] === repo);
            core.info(`Found ${sheetsData === null || sheetsData === void 0 ? void 0 : sheetsData.length} entries`);
            ...
            sheetsData.forEach((s) => {
                ...
                fs_1.writeFileSync(`${sheetPath}.max.json`, `${JSON.stringify(s.data, undefined, 2)}\n`);
                fs_1.writeFileSync(`${sheetPath}.json`, `${JSON.stringify(s.data)}\n`);
                if (s.config.search) {
                    ...
                    const updateData = s.data
                        ...
                        localizedParams.forEach(param => {
                            result[`${dataLocale}__${param}`] = unflatItem === null || unflatItem === void 0 ? void 0 : unflatItem[param];
                        });
                        return result;
                    })
                        .filter(p => p[key]);
